...
//Задание 3
//Найдите произведен ие num1 и num2. Добавьте слушатель события на кнопку "Задание 3" и выведите результат на экран.
...
const makeTen = () => {
	const str = 'Hello';
	resultTen.innerHTML = (str.charAt(2));//Ваш код
};
...
const makeEleven = () => {
	const num1 = 5;
	resultEleven.innerHTML = (num1%2);//Ваш код
};
...
const makeSeventeen = () => {
	const str = 'JavaScript';
	resultSeventeen.innerHTML = (str.substring(3, 6));//Ваш код
};
...
const makeEighteen = () => {
	...
	resultEighteen.innerHTML = (str.replace(/world/g, "JavaScript"));//Ваш код
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	resultNineteen.innerHTML = (str.substring(7, 12));//Ваш код
};
...
const makeTwentyOne = () => {
	resultTwentyOne.innerHTML = Math.floor(Math.random() * 10);//Ваш код
};
...
const makeTwentySeven = () => {
	resultTwentySeven.innerHTML = Math.floor(Math.random() * (100 - 50) + 50);//Ваш код
};
...
const makeTwentyNine = () => {
	resultTwentyNine.innerHTML = Math.sqrt(16,2);//Ваш код
};
...
const makeThirty = () => {
	resultThirty.innerHTML = Math.sqrt(25,2);//Ваш код
};
